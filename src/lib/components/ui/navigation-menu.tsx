...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), "group hover:text-orange-600", className)}
    {...props}
  >
    {children}{" "}
    <ChevronDownIcon
